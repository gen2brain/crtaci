...
cp -f build/libgojni.so.6 ../../frontend/android/Crtaci/crtaci/src/main/jniLibs/armeabi/libgojni.so
...
cp -f build/libgojni.so.7 ../../frontend/android/Crtaci/crtaci/src/main/jniLibs/armeabi-v7a/libgojni.so
