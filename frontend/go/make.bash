...
CGO_CXXFLAGS="-I$CHROOT/usr/include -I$INCPATH -I$INCPATH/QtCore -I$INCPATH/QtGui -I$INCPATH/QtWidgets -I$INCPATH/QtNetwork -I$INCPATH/libtorrent -Wno-unused-parameter -Wno-unused-variable" \
...
CGO_LDFLAGS="$CGO_LDFLAGS -lmpv -lasound -lGL -lEGL -lGL -lSDL2 -ljpeg -lass -lharfbuzz -lenca -lavformat -lswscale -lavdevice -lavfilter -lavcodec -lavutil -ldl -lm -lrt -lswresample -lavresample -lpostproc -lluajit-5.1 -lEGL -lGLESv2 -lX11 -lXext -lXinerama -lXrandr -lXss -lz -lxcb -lXau -lXdmcp -lXfixes" \
...
CGO_LDFLAGS="$CGO_LDFLAGS -lqxcb -lqevdevkeyboardplugin -lqevdevmouseplugin -lQt5XcbQpa -lQt5PlatformSupport -lQt5DBus -lX11-xcb -lXi -lxcb-render -lxcb-render-util -lXv -lSM -lICE -lXxf86vm -lXcursor -ldbus-1 -lxcb -lxcb-image -lxcb-icccm -lxcb-sync -lxcb-xfixes -lxcb-shm -lxcb-randr -lxcb-shape -lxcb-keysyms -lxcb-xinerama -lxcb-xkb -lxcb-util -lxcb-glx -lxkbcommon-x11 -lxkbcommon  -lfontconfig -lfreetype -ldl -lXrender -lXext -lX11 -lm -ludev -lmtdev -lEGL -lQt5Gui -ljpeg -lpng -lharfbuzz -lz -lbz2 -lGL -lQt5DBus -lQt5Core -lpthread -lGL" \
CGO_ENABLED=1 GOOS=linux GOARCH=amd64 go build -tags 'static minimal' -o build/crtaci.amd64 -v -x -ldflags "-linkmode external -s -w"
...
#CGO_LDFLAGS="$CGO_LDFLAGS -lvpx -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lmp3lame -lfdk-aac -lx264 -lx265 -lfaac" \
#CGO_LDFLAGS="$CGO_LDFLAGS -lqxcb -lqevdevkeyboardplugin -lqevdevmouseplugin -lQt5XcbQpa -lQt5PlatformSupport -lQt5DBus -lX11-xcb -lXi -lxcb-render -lxcb-render-util -lXv -lSM -lICE -lXxf86vm -lXcursor -ldbus-1 -lxcb -lxcb-image -lxcb-icccm -lxcb-sync -lxcb-xfixes -lxcb-shm -lxcb-randr -lxcb-shape -lxcb-keysyms -lxcb-xinerama -lxcb-xkb -lxcb-util -lxcb-glx -lxkbcommon-x11 -lxkbcommon  -lfontconfig -lfreetype -ldl -lXrender -lXext -lX11 -lm -ludev -lmtdev -lEGL -lQt5Gui -ljpeg -lpng -lharfbuzz -lz -lbz2 -lGL -lQt5DBus -lQt5Core -lpthread -lGL" \
#CGO_ENABLED=1 GOOS=linux GOARCH=386 go build -tags 'static minimal' -o build/crtaci.386 -v -x -ldflags "-linkmode external -s -w"
...
#CGO_LDFLAGS="$CGO_LDFLAGS -lmpv -lopengl32 -lSDL2 -ljpeg -lass -lharfbuzz -lenca -lavformat -lswscale -lavdevice -llua -lversion -lgdi32 -lopengl32 -lshlwapi -lvfw32 -lwinmm -lstrmiids -lole32 -loleaut32" \
...
#CGO_ENABLED=1 GOOS=windows GOARCH=386 go build -tags 'static minimal' -o build/crtaci.exe -v -x -ldflags "-H=windowsgui -linkmode external -s -w '-extldflags=-static-libstdc++ -static-libgcc'"
