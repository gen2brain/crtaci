...
CGO_CXXFLAGS="-I$CHROOT/usr/include -I$INCPATH -I$INCPATH/QtCore -I$INCPATH/QtGui -I$INCPATH/QtWidgets -I$INCPATH/QtNetwork -I$INCPATH/QtDBus -Wno-unused-parameter -Wno-unused-variable" \
...
CGO_LDFLAGS="$CGO_LDFLAGS -ljpeg -lQt5Network -lQt5Widgets -lQt5Gui -lQt5Core -lpthread -lpng -lharfbuzz -lfreetype -lz -lGL" \
CGO_LDFLAGS="$CGO_LDFLAGS -lmpv -lasound -lGL -lEGL -lGL -lSDL2 -ljpeg -lass -lharfbuzz -lfreetype -luchardet -lavformat -lswscale -lavdevice -lavfilter -lavcodec -lavutil -ldl -lm -lrt -lstdc++" \
...
CGO_LDFLAGS="$CGO_LDFLAGS -lfontconfig -lexpat -lfreetype -lfribidi -lglib-2.0 -lbz2 -lpng16 -lssl -lcrypto -lz" \
...
CGO_CFLAGS="-Wno-unused-parameter -Wno-unused-variable" \
CGO_CXXFLAGS="-I$INCPATH -I$INCPATH/QtCore -I$INCPATH/QtGui -I$INCPATH/QtWidgets -I$INCPATH/QtNetwork -Wno-unused-parameter -Wno-unused-variable" \
...
CGO_LDFLAGS="$CGO_LDFLAGS -lssl -lcrypto -lgdi32 -lcrypt32 -lws2_32 -lmswsock -lgdi32" \
